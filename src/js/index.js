...
function exec() {
    ...
    function createCardPlayer(player) {
        ...
        information.addEventListener("click", (e) => {
            ...
            window.location.href = `https://botafogo2024.pages.dev/src/descricao.html?id=${e.target.parentNode.dataset.id}`;
